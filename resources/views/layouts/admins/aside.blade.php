<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('type_etablissements.*') ? 'active' : '' }}" href="{{ route('type_etablissements.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('publicites.*') ? 'active' : '' }}" href="{{ route('publicites.index') }}">
