...
<body class="g-sidenav-show bg-gray-100">
    ...
    <!-- ===== SIDEBAR ===== -->
    @include('layouts.stockadmins.aside')
    ...
    <!-- Initialisation du scrollbar pour Windows -->
    <script>
        (function() {
            const isWin = navigator.platform.indexOf('Win') > -1;
            const scrollbarEl = document.querySelector('#sidenav-scrollbar');

            if (isWin && scrollbarEl && typeof Scrollbar !== 'undefined') {
                Scrollbar.init(scrollbarEl, { damping: '0.5' });
            }
        })();
    </script>
