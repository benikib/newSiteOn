                            ...
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($typeEtablissements as $type)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                                                    data-bs-target="#modalDelete{{ $type->id }}" title="Supprimer">
                                        ...
                                        <div class="modal fade" id="modalDelete{{ $type->id }}" tabindex="-1"
                                            aria-labelledby="modalDeleteLabel{{ $type->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="modalDeleteLabel{{ $type->id }}">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('type_etablissements.destroy', $type->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
